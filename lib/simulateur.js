...
(function(window) {
	...
	function makeModule() {
		...
		function newRotorOnce(g) {
			var plain = newSVG('path');
			fillSVG(plain, {'fill': '#333', 'stroke':'#333', 'stroke-width':'0', 'd':'m3,-3 h4 v2 c-1.5,0 -1.5,2 0,2 c1.5,0 1.5,-2 0,-2 v-2 h3 v2 c-1.5,0 -1.5,2 0,2 c1.5,0 1.5,-2 0,-2 v-2 h3 v2 c-1.5,0 -1.5,2 0,2 c1.5,0 1.5,-2 0,-2 v-2 c6,0 6,6 0,6 h-10 z'});
			g.appendChild(plain);
			var border = newSVG('path');
			fillSVG(border, {'fill': 'none', 'stroke':'#111', 'stroke-width':'1', 'd':'m3,-3 h10 c6,0 6,6 0,6 h-10 v10 c0,6 -6,6 -6,0 v-10  h-10 c-6,0 -6,-6 0,-6 h10 v-10 c0,-6 6,-6 6,0 z'});
			g.appendChild(border);
