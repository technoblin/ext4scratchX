...
new (function() {
	...
	var descriptor = {
		blocks: [
			...
			[' ', "Déclarer E/S numérique sur la carte %m.bdNum Init. D %m.digitPin avec %m.moduleDigit ( %s )", 'digitPin', '1', 'Choisir une E/S', 'Choisir un module', ''],
			[' ', "Déclarer entrée analogique de la carte %m.bdNum Init. A %m.analogPin avec %m.moduleAnalog ( %s )", 'analogPin', '1', 'Choisir une E/S', 'Choisir un module', ''],
			[' ', "Déclarer E/S I2C de la carte %m.bdNum Init. M %m.moduleMode ( %s )", 'moduleMode', '1', 'Choisir un mode', ''],
			[' ', "Déclarer une matrice sur le carte %m.bdNum Init. la matrice de %n x %n leds sur %m.ledPin .", 'initLed', '1', '20', '15', '1'],
			...
			[' ', "Écran LCD de la carte %m.bdNum LCD écrire %s %s .", 'LCDTxt', '1', 'Ligne 1', 'Ligne 2'],
			[' ', "Écran LCD de la carte %m.bdNum LCD éclairer %n .", 'LCDRgb', '1', '255'],
			[' ', "Écran LCD de la carte %m.bdNum LCD %m.LCD .", 'LCDMode', '1', 'Choisir une action'],
			// Gestion des modules Grove-oLED display
			[' ', "Écran oLed de la carte %m.bdNum oLed écrire %s .", 'oLEDtxt', '1', 'Texte'],
			[' ', "Écran oLed de la carte %m.bdNum oLed placer curseur %n %n .", 'oLEDXY', '1', '0', '0'],
			[' ', "Écran oLed de la carte %m.bdNum effacer l'écran oLed.", 'oLEDclear', '1'],
			[' ', "Écran oLed de la carte %m.bdNum régler contrast à %s .", 'oLEDbright', '1', '100'],
			// Gestion des matrices de LEDs
			[' ', "Matrice LED de la carte %m.bdNum Affecter à la led ( %n ; %n ) la couleur %n sur %m.ledPin .", 'setXYLed', '1', '1', '1', '255', '1'],
			[' ', "Matrice LED de la carte %m.bdNum Tracer la ligne de ( %n ; %n ) à ( %n ; %n ) de couleur %n sur %m.ledPin .", 'drawLine', '1', '1', '1', '5', '5', '255', '1'],
			[' ', "Matrice LED de la carte %m.bdNum Tracer le rectangle de ( %n ; %n ) à ( %n ; %n ) de couleur %n sur %m.ledPin .", 'drawRect', '1', '1', '1', '5', '5', '255', '1'],
			[' ', "Matrice LED de la carte %m.bdNum Remplir le rectangle de ( %n ; %n ) à ( %n ; %n ) de couleur %n sur %m.ledPin .", 'colorRect', '1', '1', '1', '5', '5', '255', '1'],
			[' ', "Matrice LED de la carte %m.bdNum Écrire en ( %n ; %n ) le texte %s de couleur %n sur %m.ledPin .", 'drawTxt', '1', '1', '1', 'TEXTE', '255', '1'],
			[' ', "Matrice LED de la carte %m.bdNum Dessiner en ( %n ; %n ) l'image %s sur %m.ledPin .", 'drawPicture', '1', '1', '1', '20/15/z/8k/0', '1'],
			[' ', "Matrice LED de la carte %m.bdNum Ajouter en ( %n ; %n ) l'image %s sur %m.ledPin .", 'addPicture', '1', '1', '1', '20/15/z/8k/0', '1'],
			[' ', "Matrice LED de la carte %m.bdNum Afficher les LEDs sur %m.ledPin .", 'fixeLeds', '1', '1'],
			[' ', "Matrice LED de la carte %m.bdNum Réinitialiser les LEDs sur %m.ledPin .", 'resetLed', '1', '1'],
			// Gestion des moteurs pas-à-pas
			[' ', "Driver moteur I2C de la carte %m.dbNum Definir le fonctionnement de %n comme %m.stepMode .",  'motorMode', '1', '5', '1. Pas-à-pas'],
			[' ', "Driver moteur I2C de la carte %m.dbNum Faire avancer le moteur %n de %n pas .",  'motorWalk', '1', '5', '20'],
			[' ', "Driver moteur I2C de la carte %m.dbNum Interrompre le moteur %n .",  'motorBreak', '1', '5'],
			[' ', "Driver moteur I2C de la carte %m.dbNum Démarrer sur %n le moteur %m.ledPin à la vitesse %n .",  'motorStart', '1', '5', '1', '200'],
			[' ', "Driver moteur I2C de la carte %m.dbNum Stopper sur %n le moteur %m.ledPin .",  'motorStop', '1', '5', '1'],
			// Gestion des servo-moteur Adafruit PWM PI/HAT
			[' ', "Shield PWM de la carte %m.dbNum Pilot %n Alimenter le moteur %n avec %n .",  'servoStart', '1', '64', '1', '100'],
			[' ', "Shield PWM de la carte %m.dbNum Pilot %n Stoper le moteur %n .",  'servoStop', '1', '64', '1'],
			[' ', "Shield PWM de la carte %m.dbNum Pilot %n configurer la fréquence %n .",  'servoFreq', '1', '64', '1000'],
			// Gestion des matrices de LEDs
			['r', "Calculer RVB %n %n %n", 'calcRVB', '255', '255', '255'],
			// Lecture sur les pins
			['h', "Lorsque sur la carte %m.bdNum l'entrée %m.digitPin est %m.logique", 'getDigitalInputState', '1', 'Choisir une E/S', '1: Haut'],
